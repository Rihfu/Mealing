...
- **Prix** : saisi **au checkout** (champ € par article dans « J'ai fait mes courses ») ET éditable ensuite **dans le relevé** (mode Éditer). Threadé par clé de ligne jusqu'à `recordShoppingTrip`.
