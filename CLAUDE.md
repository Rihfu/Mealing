...
1. **Poursuivre l'optimisation de la section Liste de courses** (chantier principal — beaucoup de détails restent à ajuster ; voir `docs/courses-ux-refonte.md`).
   ...
   - ⏳ **Reste** : aliment importé **USDA/OFF sans rayon** (`category=null`) → « Autres » (mapping catégorie à l'import à faire) ; enrichir synonymes/catalogue à l'usage ; **UX-14 mode magasin mobile** ; finitions diverses.
