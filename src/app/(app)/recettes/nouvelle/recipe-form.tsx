  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <label className="flex flex-col gap-1 text-sm">
        Nom
        <input name="name" required className="rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-900" />
      </label>

      <div className="flex gap-3">
        <label className="flex flex-1 flex-col gap-1 text-sm">
          Préparation (min)
          <input name="prep_time_min" type="number" min="0" className="rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-900" />
        </label>
        <label className="flex flex-1 flex-col gap-1 text-sm">
          Cuisson (min)
          <input name="cook_time_min" type="number" min="0" className="rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-900" />
        </label>
        <label className="flex flex-1 flex-col gap-1 text-sm">
          Portions
          <input name="servings" type="number" min="1" defaultValue="1" className="rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-900" />
        </label>
      </div>
        ...
        {rows.map((row, i) => (
          <div key={i} className="flex flex-wrap items-center gap-2">
            <select
              ...
              className="min-w-40 flex-1 rounded border border-gray-300 px-2 py-1.5 text-sm dark:border-gray-700 dark:bg-gray-900"
            >
            ...
            {!row.foodId && (
              <input
                ...
                className="flex-1 rounded border border-gray-300 px-2 py-1.5 text-sm dark:border-gray-700 dark:bg-gray-900"
              />
            )}
            <input
              placeholder="qté"
      ...
      <label className="flex flex-col gap-1 text-sm">
        Étapes
        <textarea name="instructions" rows={4} className="rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-900" />
      </label>

      <label className="flex flex-col gap-1 text-sm">
        Tags (séparés par des virgules)
        <input name="tags" placeholder="végétarien, rapide" className="rounded border border-gray-300 px-3 py-2 dark:border-gray-700 dark:bg-gray-900" />
      </label>
