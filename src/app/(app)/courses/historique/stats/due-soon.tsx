        ...
        return (
          <li key={d.key} className="flex items-center gap-3 py-2.5">
            ...
            <span className="min-w-0 flex-1">
              {d.foodId ? (
                <Link href={`/courses/produit/${d.foodId}?from=/courses/historique/stats`} className="block truncate text-sm font-semibold text-ink hover:text-green-strong hover:underline">
                  {d.label}
                </Link>
              ) : (
